...
"""
T22026/GA4/app.py — Unified GA4 sub-application
Mounted at /ga4 by the root hf_space/app.py.
"""

from fastapi import FastAPI, Request, Response
from fastapi.responses import HTMLResponse

from T22026.GA4.dashboard import DASHBOARD_HTML
from T22026.GA4.main import router as ga4_router
from T22026.GA4.shared.tenant import current_email, current_token, normalize_email
...
app = FastAPI(
    title="IITM TDS 2026-05 GA4 — RAG/Retrieval Multi-Tenant API Hub",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def ga4_preflight(full_path: str) -> Response:

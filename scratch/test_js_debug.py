...
# Write JScript file to run in cscript
jscript_content = """
...
with open("scratch/run_js_debug.js", "w", encoding="utf-8") as f:
    f.write(jscript_content)

res = subprocess.run(["cscript", "//Nologo", "scratch/run_js_debug.js"], capture_output=True, text=True)
print("CSCRIPT OUTPUT:\n", res.stdout)
